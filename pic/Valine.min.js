...
*/
    ...
    function(e, t, n) {
        ...
        default.maps,
            ...
            default.detect(i), a = '<span class="vsys"><i class="fab fa-' + (["xiaomi"].includes(i.browser.toLowerCase()) ? "mobile-alt fas": i.browser.toLowerCase()) + '"></i>' + i.browser + " " + i.version + "</span>" + " " + ('<span class="vsys"><i class="fab fa-' + (["mac os", "ios"].includes(i.os.toLowerCase()) ? "apple": i.os.toLowerCase()) + '"></i>' + i.os + " " + i.osVersion + "</span>")),
            ...
            L = function(t) {
                ...
                if (e.config.requiredFields.indexOf("mail") > -1 && !/^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/.test(E.mail)) return v.mail[0].focus(),
